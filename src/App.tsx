...
const IMAGES = {
  temazcal:
    "https://raw.githubusercontent.com/pobedaavr-sys/foto/1fbd5ce91c5ac7029a8dbf7c0d61bd466993047a/%D0%A2%D0%95%D0%9C%D0%9O%D0%A1%D0%9A%D0%90%D0%9B%D0%AC.jpg",
  nature:
    "https://raw.githubusercontent.com/pobedaavr-sys/foto/1de949d7d59e8de005cc1f1f2bfbe808280ba6d0/%D0%B2%D0%BC%D0%B5%D1%81%D1%82%D0%BE_%D0%B3%D1%80%D0%B8%D0%B1%D0%BE%D1%87%D0%BA%D0%B0.jpg",
  paints:
    "https://raw.githubusercontent.com/pobedaavr-sys/foto/1fbd5ce91c5ac7029a8dbf7c0d61bd466993047a/%D0%BA%D1%80%D0%B0%D1%81%D0%BA%D0%B8.jpg",
  fire: "https://raw.githubusercontent.com/pobedaavr-sys/foto/1de949d7d59e8de005cc1f1f2bfbe808280ba6d0/hero.jpg",
  july3:
    "https://raw.githubusercontent.com/pobedaavr-sys/foto/1fbd5ce91c5ac7029a8dbf7c0d61bd466993047a/3%20%D0%B8%D1%8E%D0%BB%D1%8F%202026.jpg",
  july4:
    "https://raw.githubusercontent.com/pobedaavr-sys/foto/1fbd5ce91c5ac7029a8dbf7c0d61bd466993047a/%D0%A2%D0%95%D0%9C%D0%9E%D0%A1%D0%9A%D0%90%D0%9B%D0%AC.jpg",
  ...
  elena:
    "https://raw.githubusercontent.com/pobedaavr-sys/foto/1fbd5ce91c5ac7029a8dbf7c0d61bd466993047a/%D0%95%D0%BB%D0%B5%D0%BD%D0%B0_%D0%9C%D0%B8%D0%BB%D1%8C%D0%BA%D0%B5%D0%B2%D0%B8%D1%87.jpg",
};
...
const SectionHeading = ({
  ...
  <div className={`mb-16 ${centered ? "text-center mx-auto" : ""}`}>
    <span
      className={`${light ? "text-text-muted" : "text-zinc-400"} uppercase tracking-[0.2em] text-[11px] font-bold block mb-4`}
    >
      {label}
    </span>
    <h2
      className={`text-4xl md:text-5xl lg:text-7xl mb-6 ${light ? "text-zinc-950" : "text-white"}`}
    >
      {title}
    </h2>
    {subtitle && (
      <p
        className={`${light ? "text-text-secondary" : "text-zinc-300"} text-lg md:text-xl max-w-2xl ${centered ? "mx-auto" : ""} leading-relaxed font-light`}
      >
        {subtitle}
      </p>
    )}
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-bg-light text-text-main">
      {/* HEADER */}
      <header
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${scrolled ? "bg-white/80 backdrop-blur-lg py-4 border-b border-border-beige" : "bg-transparent py-8"}`}
      >
        <div className="editorial-layout flex justify-between items-center text-zinc-950">
          ...
          <nav className="hidden md:flex items-center gap-12">
            {["Программа", "Практики", "Проводник", "Форматы", "Участие"].map(
              (item) => (
                <a
                  key={item}
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            <button
              className="absolute top-8 right-8 text-zinc-950"
        ...
        <div className="editorial-layout grid lg:grid-cols-2 gap-16 items-center w-full">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-text-secondary mb-12 leading-relaxed font-light">
              Женская выездная программа в тишине Ленинградской области. Три дня
              практик через Ум, Тело и Род — для возвращения к себе, внутренней
              опоре и ясности.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-6 mb-12">
              {[
                "3 дня погружения",
                "камерный круг до 20 человек",
                "практики Ум · Тело · Род",
                "без лишнего шума и оценок",
              ].map((item, idx) => (
          ...
          >
            ...
            >
              <img
                src={IMAGES.fire}
                alt="Fire"
                className="w-full h-full object-cover rounded-[320px] rounded-tl-[40px] rounded-br-[40px] shadow-2xl transition-all duration-1000 group-hover:rounded-[40px]"
              />
            </motion.div>
            <div className="absolute -bottom-10 -left-10 bg-white p-10 rounded-2xl shadow-2xl hidden lg:block border border-border-beige z-20">
              <p className="text-xs uppercase tracking-widest text-brand-accent font-bold mb-2">
                Гатчинский район
              </p>
              <p className="text-2xl font-light italic text-zinc-950">
                Три дня пути через
                <br />
                Ум, Тело и Род
              </p>
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-start gap-4 p-6 rounded-2xl bg-bg-light border border-border-beige transition-all hover:bg-bg-warm"
                  >
              ...
              >
                ...
                <div className="p-10">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="text-[10px] uppercase font-bold text-brand-accent tracking-widest">
                      {item.date}
                    </span>
        ...
        <div className="editorial-layout">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="order-1 lg:order-2">
              <SectionHeading label="Первый слой" title="СЛОЙ: УМ" />
              <h3 className="text-3xl mb-8 font-light italic">
                Игра «7 Печатей»
              </h3>
              <p className="text-text-secondary text-lg mb-10 leading-relaxed font-light">
                В игру участница входит со своим запросом. Поле игры помогает
                увидеть, где застряла энергия решения и какой следующий шаг
                может быть реальным.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-8 mb-12">
                <ul className="space-y-4">
                  {[
                    ...
                    <li
                      key={i}
                      className="flex items-center gap-3 text-sm text-text-main font-medium"
                    >
              ...
              <div className="flex justify-start">
                <button
                  type="button"
                  onClick={() => {
                    const nextState = !mindExpanded;
                    setMindExpanded(nextState);
                    if (nextState) {
                      scrollToBlock("mind-detailed-desc");
                    }
                  }}
                ...
                >
                  <span>
                    {mindExpanded
                      ? "Свернуть описание"
                      : "Подробнее об игре «7 Печатей»"}
                  </span>
                  <ChevronRight
                    className={`w-4 h-4 transition-transform duration-300 ${mindExpanded ? "rotate-90" : ""}`}
                  />
                </button>
              </div>
            </div>
            ...
            {mindExpanded && (
              ...
              >
                <div className="p-8 md:p-12 bg-[#f8f7f4] border border-[#e7dfd4] rounded-[24px]">
                  <h4 className="text-2xl md:text-3xl text-zinc-950 font-medium mb-8">
                    О игре «7 Печатей»
                  </h4>

                  <p className="text-base text-[#3a3530] font-light leading-relaxed mb-10 max-w-3xl">
                    Жизнь и каждое событие можно рассматривать как игру энергий,
                    в которую вовлечено сознание. Игра «7 Печатей» построена по
                    законам движения энергии и сознания из древних источников
                    мудрости.
                  </p>
                  ...
                  <div className="grid md:grid-cols-2 gap-x-12 gap-y-8 text-sm md:text-base leading-relaxed font-light text-[#4a4540]">
                    <div className="space-y-8">
                      <div>
                        ...
                        <p>
                          Участница входит в игру со своим запросом: ситуацией,
                          внутренним выбором или вопросом, который давно требует
                          ясности. В процессе проявляются связь событий с
                          внутренним состоянием, причины дисгармонии, ресурсы,
                          препятствия и возможные шаги к цели.
                        </p>
                      </div>

                      <div>
                        <h5 className="font-semibold text-zinc-950 mb-2">
                          Поле игры и механика
                        </h5>
                        <p>
                          Поле игры символически отражает жизнь, а движение по
                          нему помогает увидеть развитие событий. «7 Печатей» —
                          это фильтры сознания, которые могут блокировать
                          свободное движение энергии. Они связаны с мыслями,
                          эмоциями, телом и внутренним состоянием.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p>
                          В игре используются 22 энергии, связанные со старшими
                          арканами Таро. Они помогают увидеть, какие силы
                          участвуют в ситуации и какие ресурсы могут поддержать
                          движение к цели.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p>
                          По принципу синхронизации участнице выпадают поля и
                          ситуации, значимые именно для её запроса. Каждая
                          клетка становится образом ситуации, а движение по полю
                          — способом увидеть, как может разворачиваться событие.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-8">
                      <div>
                        ...
                        <p>
                          Цель игры — раскрыть печати сознания: переосмыслить
                          ограничения, увидеть ситуацию с разных сторон, найти
                          выход из трудного положения и выстроить связь между
                          внутренним состоянием и внешними событиями.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p>
                          В основе игры соединяются психология, И-Цзин,
                          сакральная геометрия, мудрость Египта и библейские
                          образы из Откровения Иоанна Богослова.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p>
                          Вы входите в игру со своим намерением — тем, что давно
                          не решается или требует более ясного взгляда. Запрос
                          проходит через базовую матрицу жизни, помогает увидеть
                          блоки и подключить ресурсы.
                        </p>
                      </div>

                      <div>
                        <h5 className="font-semibold text-zinc-950 mb-2">
                          Особенность игры с ведущей
                        </h5>
                        <p>
                          Елена Милькевич сопровождает процесс как мастер. В
                          работе она использует расстановочный подход,
                          психотерапию, атмалогию, шаманские и эзотерические
                          практики. Это помогает смотреть не только на внешнюю
                          ситуацию, но и на её причинный уровень.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p>
                          Результат может проявляться индивидуально: у кого-то
                          быстро, у кого-то постепенно. Чем глубже личная
                          работа, тем дольше может разворачиваться новая
                          внутренняя история.
                        </p>
                      </div>
                    </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <SectionHeading
                ...
                title="СЛОЙ: ТЕЛО"
              />
              <h3 className="text-3xl text-brand-accent mb-4 uppercase tracking-widest font-bold">
                ТЕМАСКАЛЬ
              </h3>
              <p className="text-xl text-zinc-300 italic font-light mb-10">
                ЦЕРЕМОНИЯ ПЕРВОГО ВДОХА
              </p>
              <div className="flex justify-start mb-10">
                <button
                  type="button"
                  onClick={() => {
                    const nextState = !bodyExpanded;
                    setBodyExpanded(nextState);
                    if (nextState) {
                      scrollToBlock("body-detailed-desc");
                    }
                  }}
                ...
                >
                  <span>
                    {bodyExpanded
                      ? "Свернуть описание"
                      : "Подробнее о Темаскале"}
                  </span>
                  <ChevronRight
                    className={`w-4 h-4 transition-transform duration-300 ${bodyExpanded ? "rotate-90" : ""}`}
                  />
                </button>
              </div>
              <p className="text-zinc-400 text-lg leading-relaxed mb-12 font-light">
                Ритуальная баня, «дом горячих камней». В полной темноте, под
                пение и ароматы трав, камни отдают жар воде, создавая
                целительный пар. Это пространство вне времени.
              </p>
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  >
                    <p className="text-[10px] uppercase text-brand-accent font-bold tracking-widest mb-1">
                      {item.attr}
                    </p>
            ...
            <div className="relative flex flex-col">
              <div className="w-full aspect-square lg:aspect-auto lg:h-[700px] bg-zinc-900 rounded-3xl overflow-hidden shadow-2xl relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-zinc-800 -z-10">
                  <span className="text-zinc-600 font-bold tracking-widest text-sm uppercase">
                    ТЕМАСКАЛЬ
                  </span>
                </div>
              </div>
        ...
        {bodyExpanded && (
          ...
          >
            <div className="p-8 md:p-12 bg-[#fdfcf9] border border-[#e7dfd4] rounded-[24px]">
              <h4 className="text-2xl md:text-3xl text-zinc-950 font-medium mb-6">
                Что такое Темаскаль
              </h4>

              <div className="space-y-4 mb-8 text-base font-light text-zinc-700">
                <p>
                  ТЕМАСКАЛЬ — ритуальная баня, «дом горячих камней». Это
                  пространство жара, темноты, пара, песен и трав, где каждый
                  вдох становится шагом к внутреннему обновлению.
                </p>
                <p>
                  В полной темноте раскалённые камни отдают жар воде, создавая
                  целительный пар. Это пространство вне привычного времени, где
                  можно остаться наедине со своей истинной сутью.
                </p>
              </div>

              <div className="border-t border-[#e7dfd4] pt-8 mb-8">
                <h5 className="text-xl text-zinc-950 font-medium mb-4">
                  ЦЕРЕМОНИЯ ПЕРВОГО ВДОХА
                </h5>
                <p className="text-base font-light text-zinc-700">
                  Церемония помогает пройти опыт закрытия старых программ и
                  открытия новых. Участница выходит из пространства Темаскаля с
                  ощущением нового дыхания, собранности и возвращения к телу.
                </p>
              </div>

              <div className="border-t border-[#e7dfd4] pt-8 mb-8">
                <h5 className="text-xl text-zinc-950 font-medium mb-6">
                  Четыре пространства и стихии
                </h5>
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    {
                      title: "Восток (Воздух) — Намерение и Призыв",
                      text: "Мы формируем свой запрос и приглашаем Духов-наставников. Это момент сонастройки и открытия пространства.",
                    },
                    {
                      title: "Юг (Огонь) — Просьба и Молитва",
                      text: "Время искреннего обращения к высшим силам о том, что действительно необходимо. Здесь участница заявляет о своих нуждах и просит об исцелении.",
                    },
                    {
                      title: "Запад (Вода) — Трансформация и Исцеление",
                      text: "Самый жаркий и глубокий этап. Здесь старое сгорает, освобождая место для исцеления и перемен.",
                    },
                    {
                      title: "Север (Земля) — Благодарность и Празднование",
                      text: "Обретение мудрости, тишины и заземления. Время благодарности жизни и празднования своего обновления.",
                    },
                  ].map((card, idx) => (
                    <div
                      key={idx}
                      className="p-6 bg-[#f8f7f4] border border-[#e7dfd4] rounded-xl"
                    >
                      <h6 className="font-semibold text-zinc-950 text-sm mb-2">
                        {card.title}
                      </h6>
              ...
              <div className="border-t border-[#e7dfd4] pt-8 grid md:grid-cols-2 gap-8">
                <div>
                  <h5 className="text-lg text-zinc-950 font-semibold mb-3">
                    Камни-Бабушки
                  </h5>
                  <p className="text-sm md:text-base font-light text-zinc-700 leading-relaxed">
                    В центре церемонии — Камни-Бабушки. Раскалённые в огне, они
                    пробуждают древнюю память о том, кто мы есть и как мы
                    взаимосвязаны со всем существованием.
                  </p>
                </div>
                <div>
                  <h5 className="text-lg text-zinc-950 font-semibold mb-3">
      ...
      <section className="py-32 bg-white" id="род">
        <div className="editorial-layout">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <SectionHeading centered label="Третий слой" title="СЛОЙ: РОД" />
            <h3 className="text-3xl mb-6 italic tracking-tight">
              САКРАЛЬНАЯ ЖЕНСКАЯ НОЧЬ
            </h3>
            <div className="flex justify-center mt-3 mb-6">
              <button
                type="button"
                onClick={() => {
                  const nextState = !rodExpanded;
                  setRodExpanded(nextState);
                  if (nextState) {
                    scrollToBlock("rod-detailed-desc");
                  }
                }}
              ...
              >
                <span>
                  {rodExpanded
                    ? "Свернуть описание"
                    : "Подробнее о Сакральной женской ночи"}
                </span>
                <ChevronRight
                  className={`w-4 h-4 transition-transform duration-300 ${rodExpanded ? "rotate-90" : ""}`}
                />
              </button>
            </div>
            <p className="text-text-secondary text-lg leading-relaxed font-light">
              Закрытый женский круг, где можно обратиться к своим корням,
              женским историям и памяти тела. Это честное возвращение к своей
              силе и внутренней опоре.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 min-h-[500px]">
            <img
              src={IMAGES.rod}
              alt="Ancestors practice"
              className="w-full h-full object-cover rounded-3xl"
            />
            <div className="bg-bg-warm rounded-3xl p-16 flex flex-col justify-center items-start">
              <span className="text-brand-accent text-xs uppercase font-bold tracking-widest mb-6">
                Опыт проживания
              </span>
          ...
          <AnimatePresence initial={false}>
            {rodExpanded && (
              ...
              >
                <div className="p-8 md:p-12 bg-[#fdfcf9] border border-[#e7dfd4] rounded-[24px]">
                  <h4 className="text-2xl md:text-3xl text-zinc-950 font-medium mb-6">
                    Сакральный смысл практики
                  </h4>

                  <div className="space-y-4 mb-8 text-base font-light text-zinc-700">
                    <p>
                      Сакральная женская ночь — это пространство глубокой
                      тишины, молитвы и обращения к корням. Это веками
                      проверенный ритуал соучастия, соприкосновения и передачи
                      силы, где каждая женщина может почувствовать себя частью
                      великой цепи жизни.
                    </p>
                    <p>
                      Время, когда женщина может соединиться со своей глубинной
                      женской силой, получить поддержку рода и освободиться от
                      старых, отживших сценариев, которые больше не служат её
                      развитию.
                    </p>
                  </div>
                  ...
                  <div className="border-t border-[#e7dfd4] pt-8 mb-8">
                    <h5 className="text-xl text-zinc-950 font-medium mb-4">
                      Этапы и опыт проживания
                    </h5>
                    <p className="text-base font-light text-zinc-700 leading-relaxed">
                      Очищение через огонь и воду, создание безопасного
                      пространства круга, сонастройка с естественными ритмами
                      природы. Практика глубокого обращения к прародительницам
                      рода, бережное восстановление прерванных межпоколенческих
                      связей и получение благословения на счастливую долю.
                    </p>
                  </div>
                  ...
                  <div className="border-t border-[#e7dfd4] pt-8 grid md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <p className="text-sm md:text-base font-light text-zinc-700 leading-relaxed">
                        Через бережные медитативные и телесные практики мы
                        воссоздаем контакт со своей семейной системой. Это
                        помогает трансформировать накопленный поколениями опыт в
                        мощный ресурс поддержки, любви и вдохновения.
                      </p>
                    </div>
                    <div>
                      <h5 className="text-lg text-zinc-950 font-semibold mb-3">
      ...
      {/* BLOCK 10: PROVODNIK */}
      <section
        className="relative z-10 py-16 md:py-24 lg:py-32 bg-white overflow-hidden"
        id="проводник"
      >
        <div className="editorial-layout px-6">
          <SectionHeading
          ...
          <div className="grid lg:grid-cols-[45%_55%] gap-12 md:gap-16 lg:gap-20 items-start">
            <div className="relative">
              <img
                src={IMAGES.elena}
                alt="Елена Милькевич"
                className="w-full h-auto aspect-[3/4] object-cover rounded-3xl shadow-xl"
              />
            ...
            <div className="pt-4">
              <h3 className="text-4xl font-medium text-zinc-950 mb-6">
                Елена Милькевич
              </h3>
              <p className="text-text-secondary text-lg mb-10 leading-relaxed font-light">
                Психолог и парапсихолог с более чем 20-летней практикой.
                Соединяет современные знания, древние традиции и опыт глубинной
                работы с состояниями и запросами участниц.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-start gap-4 p-5 rounded-2xl bg-white border border-border-beige shadow-sm transition-all hover:border-brand-accent"
                  >
                    <div className="w-1.5 h-1.5 rounded-full bg-brand-accent mt-2 shrink-0" />
                    <span className="text-sm text-text-main font-medium leading-relaxed">
                      {fact}
                    </span>
                  </div>
                ))}
        ...
        <div className="editorial-layout px-6">
          <div className="max-w-[1200px] mx-auto p-10 md:p-16 bg-[#0b0b0d] rounded-[32px] md:rounded-[40px] text-center text-white relative overflow-hidden">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-6 mb-14 text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold">
              <span className="px-6 py-3 border border-zinc-800 rounded-full whitespace-nowrap">
                «7 ПЕЧАТЕЙ»
              </span>
              <span className="px-6 py-3 border border-zinc-800 rounded-full whitespace-nowrap">
                «ТЕМАСКАЛЬ»
              ...
              <span className="px-6 py-3 border border-zinc-800 rounded-full text-brand-accent border-zinc-800 whitespace-nowrap">
                «ИСЦЕЛЕНИЕ»
              </span>
            </div>
          ...
          <div className="mt-16 pt-16 border-t border-zinc-100 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
              {["Программа", "Практики", "Проводник", "Formats", "FAQ"].map(
                (item) => (
                  <a
                    key={item}
...
function ParticipationCard({
  ...
  return (
    ...
    >
      ...
      <div className="mb-10">
        <h3
          className={`text-2xl mb-6 font-medium leading-tight ${featured ? "text-brand-accent" : ""}`}
        >
          {name}
        </h3>
        <p
          className={`text-sm leading-relaxed ${featured ? "text-zinc-400" : "text-text-secondary"}`}
        >
          {description}
        </p>
      </div>
      ...
      <div className="flex-grow space-y-6 mb-12">
        {[
          ...
          >
            <span className={featured ? "text-zinc-500" : "text-text-muted"}>
              {p.date}
            </span>
            <span
              className={`font-bold ${featured ? "text-white" : "text-text-main"}`}
            >
              {p.price}
            </span>
          </div>
  ...
  return (
    <div className="border border-border-beige rounded-2xl bg-white overflow-hidden transition-all duration-300 hover:border-brand-accent">
      <button
        ...
        aria-controls={id}
      >
        <span className="text-lg font-medium text-zinc-950 pr-8">
          {question}
        </span>
        <div
          className={`shrink-0 w-6 h-6 rounded-full border border-border-beige flex items-center justify-center transition-transform duration-300 ${isOpen ? "rotate-180 bg-brand-accent text-white border-brand-accent" : "text-text-muted"}`}
        >
          <ChevronRight
